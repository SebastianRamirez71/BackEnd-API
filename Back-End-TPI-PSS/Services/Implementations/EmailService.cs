...
namespace Back_End_TPI_PSS.Services.Implementations
{
    public class EmailService : IEmailService
    {
        ...
        public void SendEmail(ProductDto product, User user)
        {
            ...
            string subject = $"Hola {user.Name} tenemos ¡Nuevo producto en la web!";
